...
class CartonLogicTester:
    ...
    def _test_two_level_mode(self):
        ...
        self._run_test({
            ...
            "expected": {
                ...
                "large_boxes_per_set_ratio": 1.875,  # 15/8 = 1.875
                "actual_large_boxes_per_set": 2,     # ceil(1.875) = 2
        ...
        self._run_test({
            ...
            "expected": {
                ...
                "large_boxes_per_set_ratio": 2.5,   # 10/4 = 2.5
                "actual_large_boxes_per_set": 3,    # ceil(2.5) = 3
    ...
    def _calculate_carton_logic(self, params: Dict[str, Any], data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if has_small_box:
            ...
            result.update({
                ...
                "small_boxes_per_set_ratio": small_boxes_per_set_ratio,
                "actual_small_boxes_per_set": actual_small_boxes_per_set,
                "large_boxes_per_set_ratio": large_boxes_per_set_ratio,
            ...
            for i in range(1, total_large_boxes + 1):
                carton_no = self.processor.calculate_carton_range_for_large_box(i, large_boxes_per_set_ratio, total_sets)
                large_carton_nos.append(carton_no)
            result["large_carton_nos"] = large_carton_nos
            
        else:
            # 无小箱模式
            boxes_per_large_box = int(params["盒/小箱"])  # 在无小箱模式下这是盒/大箱
    ...
    def _export_results(self):
        ...
        json_filename = f"total-result/test_results_fixed_{timestamp}.json"
        md_filename = f"total-result/test_report_fixed_{timestamp}.md"
    ...
    def _export_markdown_report(self, filename: str, data: Dict[str, Any]):
        ...
        with open(filename, 'w', encoding='utf-8') as f:
            ...
            f.write(f"- **无小箱模式**: 一套分多个/一个/多套分一个大箱\n")
            f.write(f"- **有小箱模式**: 小箱标和大箱标的所有Carton No模式\n")
