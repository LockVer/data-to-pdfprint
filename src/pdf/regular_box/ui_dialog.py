...
class RegularUIDialog:
    ...
    def show_parameters_dialog(self):
        ...
        self.second_param_label.grid(row=1, column=0, sticky=tk.E, pady=10, padx=(0, 15))
        ...
        self.second_param_entry.grid(row=1, column=1, sticky=tk.W+tk.E, pady=10)

        # 第三个参数（只在有小箱时显示）
        self.third_param_label = ttk.Label(params_frame, text="小箱/大箱:", font=("Arial", 11))
